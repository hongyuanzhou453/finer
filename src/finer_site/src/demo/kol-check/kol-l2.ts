/**
 * Derive a per-KOL 观点潮汐快照 (KOLSnapshotData) from the radar snapshot.
 * Ported verbatim from the dashboard L2 bridge. The 本期研判 narrative is
 * data-derived so the hero verdict and the timeline numbers reconcile.
 */
